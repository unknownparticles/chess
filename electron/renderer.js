...
function initBoard() {
    ...
    for (let r = 0; r < SIZE; r++) {
        for (let c = 0; c < SIZE; c++) {
            ...
            // Adjust cell lines for smaller boards
            if (SIZE < 5) {
